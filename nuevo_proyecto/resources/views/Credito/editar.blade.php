...
<html lang="es">
    ...
    <section class="home">
        <div class="text">Modificar Tarjeta de Credito</div>
        ...
        <div class="cont-modificar">
            <img src="{{ asset('img/logo.png') }}" alt="">
                ...
                @csrf
                        ...
                        <input type="hidden" name="COD_TAR_CREDITO" value="{{ $resulcredito['COD_TAR_CREDITO'] }}">
                    
                    <div class="inputFormulario">
                        <label for="NOMBRE">Nombre</label>
                        <input type="text" name="NOM_PERSONA" value="{{ $resulcredito['NOM_PERSONA'] }}" required> 
                    </div>


                    <div class="inputFormulario">
                        <label for="APELLDO">Numero de Tarjeta</label>
                        <input type="text" name="NUM_TARJETA" value="{{ $resulcredito['NUM_TARJETA'] }}" required> 
                    </div>

                    <div class="inputFormulario">
                        <label for="INTERESES">CVV</label>
                        <input type="text" name="CVV" value="{{ $resulcredito['CVV'] }}" required> 
                    </div>
